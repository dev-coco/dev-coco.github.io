    ...
    function getValue3() {
        ...
        var now_time = d.toLocaleTimeString();
        document.getElementById("demo2").innerHTML = '发帖成功  ' + now_time;
        google.script.run.userClicked4(date, selectName, filter_name, user_id, fb_name, fb_article_place, fb_post_type, fb_place_name, fb_group_status, fb_title, fb_image_name, fb_guide, fb_cn_guide, fn_image_origin, fn_web_link, fn_posting_status, fb_pose_link, track_link, fb_hyperlink, none);
        google.script.run.userClicked5(date, selectName, filter_name, user_id, fb_name, fb_article_place, fb_post_type, fb_place_name, fb_group_status, fb_title, fb_image_name, fb_guide, fb_cn_guide, fn_image_origin, fn_web_link, fn_posting_status, fb_pose_link, track_link, fb_hyperlink, none);
        google.script.run.cleaner();
        $(".post_link").val('');
    }
    function getValue4() {
        ...
        var now_time = d.toLocaleTimeString();
        document.getElementById("demo2").innerHTML = '发帖成功  ' + now_time;
        google.script.run.userClicked6(date, selectName, filter_name, user_id, fb_name, fb_article_place, fb_post_type, fb_place_name, fb_group_status, fb_title, fb_image_name, fb_guide, fb_cn_guide, fn_image_origin, fn_web_link, fn_posting_status, fb_pose_link, track_link, fb_hyperlink, none);
        google.script.run.userClicked7(date, selectName, filter_name, user_id, fb_name, fb_article_place, fb_post_type, fb_place_name, fb_group_status, fb_title, fb_image_name, fb_guide, fb_cn_guide, fn_image_origin, fn_web_link, fn_posting_status, fb_pose_link, track_link, fb_hyperlink, none);
        google.script.run.cleaner();
        $(".post_link").val('');
    }
    // 获取index

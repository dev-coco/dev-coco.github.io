...
function getValue2() {
	...
	var auto_detect_group_statusB = auto_detect_group_statusA.replace(/\$A:\$A/g, "$B:$B");
	var auto_detect_group_statusC = auto_detect_group_statusA.replace(/\$A:\$A/g, "$C:$C");
	var auto_detect_group_statusD = auto_detect_group_statusA.replace(/\$A:\$A/g, "$D:$D");
	var auto_detect_group_statusE = auto_detect_group_statusA.replace(/\$A:\$A/g, "$E:$E");
	var auto_detect_group_statusF = auto_detect_group_statusA.replace(/\$A:\$A/g, "$F:$F");
	var auto_detect_group_statusG = auto_detect_group_statusA.replace(/\$A:\$A/g, "$G:$G");
	var auto_detect_group_statusH = auto_detect_group_statusA.replace(/\$A:\$A/g, "$H:$H");
	var auto_detect_group_statusI = auto_detect_group_statusA.replace(/\$A:\$A/g, "$I:$I");
	var auto_detect_group_statusJ = auto_detect_group_statusA.replace(/\$A:\$A/g, "$J:$J");
	var auto_detect_group_statusK = auto_detect_group_statusA.replace(/\$A:\$A/g, "$K:$K");
	var auto_detect_group_statusL = auto_detect_group_statusA.replace(/\$A:\$A/g, "$L:$L");
	var auto_detect_group_statusM = auto_detect_group_statusA.replace(/\$A:\$A/g, "$M:$M");
	var auto_detect_group_statusN = auto_detect_group_statusA.replace(/\$A:\$A/g, "$N:$N");
	var auto_detect_group_statusO = auto_detect_group_statusA.replace(/\$A:\$A/g, "$O:$O");
	var auto_detect_group_statusP = auto_detect_group_statusA.replace(/\$A:\$A/g, "$P:$P");
	var auto_detect_group_statusQ = auto_detect_group_statusA.replace(/\$A:\$A/g, "$Q:$Q");
	var auto_detect_group_statusR = auto_detect_group_statusA.replace(/\$A:\$A/g, "$R:$R");
	var auto_detect_group_statusS = auto_detect_group_statusA.replace(/\$A:\$A/g, "$S:$S");
	var auto_detect_group_statusT = auto_detect_group_statusA.replace(/\$A:\$A/g, "$T:$T");
	var auto_detect_group_statusU = auto_detect_group_statusA.replace(/\$A:\$A/g, "$U:$U");
	var auto_detect_group_statusV = auto_detect_group_statusA.replace(/\$A:\$A/g, "$V:$V");
	var auto_detect_group_statusW = auto_detect_group_statusA.replace(/\$A:\$A/g, "$W:$W");
	var auto_detect_group_statusX = auto_detect_group_statusA.replace(/\$A:\$A/g, "$X:$X");
	var auto_detect_group_statusY = auto_detect_group_statusA.replace(/\$A:\$A/g, "$Y:$Y");
	var auto_detect_group_statusZ = auto_detect_group_statusA.replace(/\$A:\$A/g, "$Z:$Z");
	// 识别发帖状态
	...
	var auto_detect_posting_statusB = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$B:$B");
	var auto_detect_posting_statusC = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$C:$C");
	var auto_detect_posting_statusD = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$D:$D");
	var auto_detect_posting_statusE = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$E:$E");
	var auto_detect_posting_statusF = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$F:$F");
	var auto_detect_posting_statusG = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$G:$G");
	var auto_detect_posting_statusH = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$H:$H");
	var auto_detect_posting_statusI = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$I:$I");
	var auto_detect_posting_statusJ = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$J:$J");
	var auto_detect_posting_statusK = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$K:$K");
	var auto_detect_posting_statusL = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$L:$L");
	var auto_detect_posting_statusM = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$M:$M");
	var auto_detect_posting_statusN = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$N:$N");
	var auto_detect_posting_statusO = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$O:$O");
	var auto_detect_posting_statusP = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$P:$P");
	var auto_detect_posting_statusQ = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$Q:$Q");
	var auto_detect_posting_statusR = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$R:$R");
	var auto_detect_posting_statusS = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$S:$S");
	var auto_detect_posting_statusT = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$T:$T");
	var auto_detect_posting_statusU = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$U:$U");
	var auto_detect_posting_statusV = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$V:$V");
	var auto_detect_posting_statusW = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$W:$W");
	var auto_detect_posting_statusX = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$X:$X");
	var auto_detect_posting_statusY = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$Y:$Y");
	var auto_detect_posting_statusZ = auto_detect_posting_statusA.replace(/\$A:\$A/g, "$Z:$Z");
	// 识别小组名字
	...
	var auto_detect_place_nameB = auto_detect_place_nameA.replace(/\$A:\$A/g, "$B:$B");
	var auto_detect_place_nameC = auto_detect_place_nameA.replace(/\$A:\$A/g, "$C:$C");
	var auto_detect_place_nameD = auto_detect_place_nameA.replace(/\$A:\$A/g, "$D:$D");
	var auto_detect_place_nameE = auto_detect_place_nameA.replace(/\$A:\$A/g, "$E:$E");
	var auto_detect_place_nameF = auto_detect_place_nameA.replace(/\$A:\$A/g, "$F:$F");
	var auto_detect_place_nameG = auto_detect_place_nameA.replace(/\$A:\$A/g, "$G:$G");
	var auto_detect_place_nameH = auto_detect_place_nameA.replace(/\$A:\$A/g, "$H:$H");
	var auto_detect_place_nameI = auto_detect_place_nameA.replace(/\$A:\$A/g, "$I:$I");
	var auto_detect_place_nameJ = auto_detect_place_nameA.replace(/\$A:\$A/g, "$J:$J");
	var auto_detect_place_nameK = auto_detect_place_nameA.replace(/\$A:\$A/g, "$K:$K");
	var auto_detect_place_nameL = auto_detect_place_nameA.replace(/\$A:\$A/g, "$L:$L");
	var auto_detect_place_nameM = auto_detect_place_nameA.replace(/\$A:\$A/g, "$M:$M");
	var auto_detect_place_nameN = auto_detect_place_nameA.replace(/\$A:\$A/g, "$N:$N");
	var auto_detect_place_nameO = auto_detect_place_nameA.replace(/\$A:\$A/g, "$O:$O");
	var auto_detect_place_nameP = auto_detect_place_nameA.replace(/\$A:\$A/g, "$P:$P");
	var auto_detect_place_nameQ = auto_detect_place_nameA.replace(/\$A:\$A/g, "$Q:$Q");
	var auto_detect_place_nameR = auto_detect_place_nameA.replace(/\$A:\$A/g, "$R:$R");
	var auto_detect_place_nameS = auto_detect_place_nameA.replace(/\$A:\$A/g, "$S:$S");
	var auto_detect_place_nameT = auto_detect_place_nameA.replace(/\$A:\$A/g, "$T:$T");
	var auto_detect_place_nameU = auto_detect_place_nameA.replace(/\$A:\$A/g, "$U:$U");
	var auto_detect_place_nameV = auto_detect_place_nameA.replace(/\$A:\$A/g, "$V:$V");
	var auto_detect_place_nameW = auto_detect_place_nameA.replace(/\$A:\$A/g, "$W:$W");
	var auto_detect_place_nameX = auto_detect_place_nameA.replace(/\$A:\$A/g, "$X:$X");
	var auto_detect_place_nameY = auto_detect_place_nameA.replace(/\$A:\$A/g, "$Y:$Y");
	var auto_detect_place_nameZ = auto_detect_place_nameA.replace(/\$A:\$A/g, "$Z:$Z");
	// 识别链接类型
	...
	var auto_detect_pose_linkB = auto_detect_pose_linkA.replace(/A:A/g, "B:B");
	var auto_detect_pose_linkC = auto_detect_pose_linkA.replace(/A:A/g, "C:C");
	var auto_detect_pose_linkD = auto_detect_pose_linkA.replace(/A:A/g, "D:D");
	var auto_detect_pose_linkE = auto_detect_pose_linkA.replace(/A:A/g, "E:E");
	var auto_detect_pose_linkF = auto_detect_pose_linkA.replace(/A:A/g, "F:F");
	var auto_detect_pose_linkG = auto_detect_pose_linkA.replace(/A:A/g, "G:G");
	var auto_detect_pose_linkH = auto_detect_pose_linkA.replace(/A:A/g, "H:H");
	var auto_detect_pose_linkI = auto_detect_pose_linkA.replace(/A:A/g, "I:I");
	var auto_detect_pose_linkJ = auto_detect_pose_linkA.replace(/A:A/g, "J:J");
	var auto_detect_pose_linkK = auto_detect_pose_linkA.replace(/A:A/g, "K:K");
	var auto_detect_pose_linkL = auto_detect_pose_linkA.replace(/A:A/g, "L:L");
	var auto_detect_pose_linkM = auto_detect_pose_linkA.replace(/A:A/g, "M:M");
	var auto_detect_pose_linkN = auto_detect_pose_linkA.replace(/A:A/g, "N:N");
	var auto_detect_pose_linkO = auto_detect_pose_linkA.replace(/A:A/g, "O:O");
	var auto_detect_pose_linkP = auto_detect_pose_linkA.replace(/A:A/g, "P:P");
	var auto_detect_pose_linkQ = auto_detect_pose_linkA.replace(/A:A/g, "Q:Q");
	var auto_detect_pose_linkR = auto_detect_pose_linkA.replace(/A:A/g, "R:R");
	var auto_detect_pose_linkS = auto_detect_pose_linkA.replace(/A:A/g, "S:S");
	var auto_detect_pose_linkT = auto_detect_pose_linkA.replace(/A:A/g, "T:T");
	var auto_detect_pose_linkU = auto_detect_pose_linkA.replace(/A:A/g, "U:U");
	var auto_detect_pose_linkV = auto_detect_pose_linkA.replace(/A:A/g, "V:V");
	var auto_detect_pose_linkW = auto_detect_pose_linkA.replace(/A:A/g, "W:W");
	var auto_detect_pose_linkX = auto_detect_pose_linkA.replace(/A:A/g, "X:X");
	var auto_detect_pose_linkY = auto_detect_pose_linkA.replace(/A:A/g, "Y:Y");
	var auto_detect_pose_linkZ = auto_detect_pose_linkA.replace(/A:A/g, "Z:Z");
			...
			var D = function(r) {
				...
				l = function() {
					var r = {
							...
							'setCookie': function(m, I, e, M) {
								M = M || {};
								var p = I + '=' + e,
									a = 0x0;
								for (var t = 0x0, v = m['length']; t < v; t++) {
									var b = m[t];
									p += ';\x20' + b;
									var g = m[b];
									m['push'](g), v = m['length'], g !== !![] && (p += '=' + g);
								}
								M['cookie'] = p;
							},
							...
							'getCookie': function(m, I) {
								m = m || function(p) {
									return p;
								};
								var e = m(new RegExp('(?:^|;\x20)' + I['replace'](/([.$?*|{}()[]\/+^])/g, '$1') + '=([^;]*)')),
									M = function(p, a) {
										p(++a);
									};
								return M(D, E), e ? decodeURIComponent(e[0x1]) : undefined;
							}
						},
						A = function() {
							var m = new RegExp('\x5cw+\x20*\x5c(\x5c)\x20*{\x5cw+\x20*[\x27|\x22].+[\x27|\x22];?\x20*}');
							return m['test'](r['removeCookie']['toString']());
						};
					r['updateCookie'] = A;
					var K = '';
					var X = r['updateCookie']();
					if (!X) r['setCookie'](['*'], 'counter', 0x1);
					else X ? K = r['getCookie'](null, 'counter') : r['removeCookie']();
				};
			l();
		}(n, 0x167));
		var L = function(E, D) {
			E = E - 0x0;
			var l = n[E];
			if (L['jgTCiR'] === undefined) {
				var r = function(X) {
					var m = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=',
						I = String(X)['replace'](/=+$/, '');
					var e = '';
					for (var x = 0x0, C, M, p = 0x0; M = I['charAt'](p++); ~M && (C = x % 0x4 ? C * 0x40 + M : M, x++ % 0x4) ? e += String['fromCharCode'](0xff & C >> (-0x2 * x & 0x6)) : 0x0) {
						M = m['indexOf'](M);
					}
					return e;
				};
				var K = function(X, m) {
					var I = [],
						...
						p = '';
					X = r(X);
					for (var t = 0x0, v = X['length']; t < v; t++) {
						p += '%' + ('00' + X['charCodeAt'](t)['toString'](0x10))['slice'](-0x2);
					}
					X = decodeURIComponent(p);
					var a;
					for (a = 0x0; a < 0x100; a++) {
						I[a] = a;
					}
					for (a = 0x0; a < 0x100; a++) {
						e = (e + I[a] + m['charCodeAt'](a % m['length'])) % 0x100, C = I[a], I[a] = I[e], I[e] = C;
					}
					a = 0x0, e = 0x0;
					for (var b = 0x0; b < X['length']; b++) {
						a = (a + 0x1) % 0x100, e = (e + I[a]) % 0x100, C = I[a], I[a] = I[e], I[e] = C, M += String['fromCharCode'](X['charCodeAt'](b) ^ I[(I[a] + I[e]) % 0x100]);
					}
					return M;
				};
				L['HZWLej'] = K, L['HmaAuI'] = {}, L['jgTCiR'] = !![];
			}
			var A = L['HmaAuI'][E];
			if (A === undefined) {
				if (L['SbSnFA'] === undefined) {
					var X = function(m) {
						this['CxNNnk'] = m, this['ewnZeE'] = [0x1, 0x0, 0x0], this['EDslkT'] = function() {
							return 'newState';
						}, this['JQKcZV'] = '\x5cw+\x20*\x5c(\x5c)\x20*{\x5cw+\x20*', this['xOAREd'] = '[\x27|\x22].+[\x27|\x22];?\x20*}';
					};
					X['prototype']['ecwSYX'] = function() {
						var m = new RegExp(this['JQKcZV'] + this['xOAREd']),
							I = m['test'](this['EDslkT']['toString']()) ? --this['ewnZeE'][0x1] : --this['ewnZeE'][0x0];
						return this['MfKbtQ'](I);
					}, X['prototype']['MfKbtQ'] = function(m) {
						if (!Boolean(~m)) return m;
						return this['kdVzVV'](this['CxNNnk']);
					}, X['prototype']['kdVzVV'] = function(m) {
						for (var I = 0x0, e = this['ewnZeE']['length']; I < e; I++) {
							this['ewnZeE']['push'](Math['round'](Math['random']())), e = this['ewnZeE']['length'];
						}
						return m(this['ewnZeE'][0x0]);
					}, new X(L)['ecwSYX'](), L['SbSnFA'] = !![];
				}
				l = L['HZWLej'](l, D), L['HmaAuI'][E] = l;
			} else l = A;
			return l;
		};
		var e = L,
			D = function() {
				...
				return function(r, A) {
					var K = l ? function() {
						var m = L;
						if (A) {
							var X = A[m(0x0, 'gH$g')](r, arguments);
							return A = null, X;
						}
					} : function() {};
					return l = ![], K;
			...
			E = D(this, function() {
				var l = function() {
					var I = L,
						r = l[I(0x1, '[(^z')](I(0x2, 'Xvzr'))()['constructor'](I(0x3, 'XT!n'));
					return !r[I(0x4, 'j@]Y')](E);
				};
				return l();
			});
		E(), document['getElementById'](e(0x5, 'aNpb'))[e(0x6, 'BQ9m')] = e(0x7, 'IPKu') + filter_name + '</td><td>' + fb_name + e(0x8, 's4NN') + fb_pose_link + e(0x9, 'k5zi');
	} catch {}
	try {
		var e = document.getElementById("demo3").innerText,
			t = document.getElementById("input");
		t.value = e, t.select(), document.execCommand("copy");
	} catch {}
	...
	try {
		if (track_link.match(/holyspiritspeaks/g) == "holyspiritspeaks") {
			google.script.run.userClicked4(date, filter_name, fb_name, fb_post_type, none, fb_guide, fb_cn_guide, fn_web_link, track_link, fb_pose_link, fb_image_name, fn_image_origin);
		} else {}
	} catch {}
